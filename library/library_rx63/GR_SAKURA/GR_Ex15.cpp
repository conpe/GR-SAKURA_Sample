...
void gr_ex::begin(void){
	...
	// GPIO初期化
	setPinMode(GREX_IO0, PIN_OUTPUT);
	setPinMode(GREX_IO1, PIN_OUTPUT);
	setPinMode(GREX_IO2, PIN_OUTPUT);
	setPinMode(GREX_IO3, PIN_OUTPUT);
	setPinMode(GREX_IO4, PIN_OUTPUT);
	setPinMode(GREX_IO5, PIN_OUTPUT);
	setPinMode(GREX_IO6, PIN_OUTPUT);
	setPinMode(GREX_IO7, PIN_OUTPUT);
...
void gr_ex::startAD(void){
	...
	// 加算処理
	S12AD.ADADS0.BIT.ADS0 = 0xff;	//　CH0-15 : on
